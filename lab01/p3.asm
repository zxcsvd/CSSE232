...
# Modified by:  Bo Peng, 10 Sep. 2014
#
...
main:                           # Program starts at main.
	...
	la	$t4, total
	lw 	$t2, 52($t1)    # Register $t2 gets A[13]
	lw 	$t3, 56($t1)    # Register $t3 gets A[14]
	lw	$t5, 48($t1)	# Register $t3 gets A[12]

	add	$t3, $t2, $t3   # Register $t3 gets A[13]+ A[14]
	add	$t3, $t3, $t5   # Register $t3 gets A[13]+ A[14]+ A[12] 

	sw 	$t3, 0($t4)    # total gets $t3
	syscall                 #   ... Exit.
